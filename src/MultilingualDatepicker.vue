<template>
  <div class="space-y-3 relative pl-5 pr-5 sm:pl-10 sm:pr-10 md:pl-20 md:pr-20 lg:pr-20 lg:pr-20" v-toggle-calendar:aways>
      <slot
      ...
      <Transition enter-from-class="opacity-0 scale-95"
          ...
          <div v-if="showCalendar" class="multilingual-datepicker-calendar pl-4 pr-10 bg-white rounded-[10px] py-5 px-6 shadow-xl text-xs flex items-start space-x-3 z-[99] min-w-0 md:w-2/5 lg:w-2/5 xl:w-2/5">
              ...
              <button @click="calendarView.addMonth()" class="w-10 h-10 hover:bg-gray-100 rounded-full">
                ...
                class="w-18 h-10 font-semibold text-base sm:text-base text-sm hover:bg-gray-100 rounded-[10px] overflow-y-auto md:overflow-scroll">
                    ...
                    <option class="font-semibold text-base text-xs" value="nl">Nederlands</option>
                    <option class="font-semibold text-base text-xs" value="pl">Polski</option>
                    ...
                    <option class="font-semibold text-base text-xs" value="cs">Čeština</option>
                    <option class="font-semibold text-base text-xs" value="ko">한국어</option>
                    <option class="font-semibold text-base text-xs" value="uk">Українська</option>
                    <option class="font-semibold text-base text-xs" value="ar">العربية </option>
                    <option class="font-semibold text-base text-xs" value="el">Ελληνικά</option>
